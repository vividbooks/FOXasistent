/** Přípustné přípony dokladu (malá písmena, včetně tečky). */
...
const RECEIPT_MIMES = new Set([
  "image/jpeg",
  /** Některé prohlížeče / fotoaparáty posílají neplatné, ale běžné MIME */
  "image/jpg",
  "image/pjpeg",
  "image/png",
  "image/webp",
...
/** Kontrola souboru pro nahrání dokladu (klient i API). */
...
/** Přípona pro uložení na disk, když chybí v názvu souboru. */
export function fallbackReceiptExt(
  mime: string,
  extLower: string,
): string {
